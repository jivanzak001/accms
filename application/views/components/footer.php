                ...
                <footer class="footer-content">
                    <span id="tour-19">
                        2016 - <span id="copyright-year"></span> &copy; Blankon Admin. Created by <a href="#" target="_blank">Djava UI</a>, Yogyakarta ID
                    </span>                    
        ...
        <script src="<?php echo base_url();?>assets/global/plugins/bower_components/bootstrap-session-timeout/dist/bootstrap-session-timeout.min.js"></script>
        <script src="<?php echo base_url();?>assets/global/plugins/bower_components/flot/jquery.flot.js"></script>
        <script src="<?php echo base_url();?>assets/global/plugins/bower_components/flot/jquery.flot.spline.min.js"></script>
        <script src="<?php echo base_url();?>assets/global/plugins/bower_components/flot/jquery.flot.categories.js"></script>
        <script src="<?php echo base_url();?>assets/global/plugins/bower_components/flot/jquery.flot.tooltip.min.js"></script>
        <script src="<?php echo base_url();?>assets/global/plugins/bower_components/flot/jquery.flot.resize.js"></script>
        <script src="<?php echo base_url();?>assets/global/plugins/bower_components/flot/jquery.flot.pie.js"></script>
        <script src="<?php echo base_url();?>assets/global/plugins/bower_components/dropzone/downloads/dropzone.min.js"></script>
        <script src="<?php echo base_url();?>assets/global/plugins/bower_components/jquery.gritter/js/jquery.gritter.min.js"></script>
        <script src="<?php echo base_url();?>assets/global/plugins/bower_components/skycons-html5/skycons.js"></script>
        <script src="<?php echo base_url();?>assets/global/plugins/bower_components/waypoints/lib/jquery.waypoints.min.js"></script>
        <script src="<?php echo base_url();?>assets/global/plugins/bower_components/counter-up/jquery.counterup.min.js"></script>
        <script src="<?php echo base_url();?>assets/global/plugins/bower_components/bootstrap-tour/build/js/bootstrap-tour.min.js"></script>
        <!--/ END PAGE LEVEL PLUGINS -->

        <!-- START @PAGE LEVEL SCRIPTS -->
        <script src="<?php echo base_url();?>assets/admin/js/apps.js"></script>
        <script src="<?php echo base_url();?>assets/admin/js/pages/blankon.dashboard.js"></script>
