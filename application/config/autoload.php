...
/**
	...
	* @Time 		: 18:50 
	* @Function 	: $autoload['libraries']
	* @Task 		: add auto load database|session
**/
/**
	* @Project 		: ACCMS v1 Build 201608 
	* @author 		: Projekt Händler GmbH
	...
	* @Date 		: 16-08-2016 (Tuesday)
	* @Time 		: 18:00 
	* @Function 	: auto load app library
	* @Task 		: add autoload app,
**/  
$autoload['libraries'] = array('database',  'session' , 'app');
